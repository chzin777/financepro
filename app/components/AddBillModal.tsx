...
import { ExpenseCategory, CATEGORIES } from '../lib/types';
...
export default function AddBillModal({ isOpen, onClose, onAdd }: AddBillModalProps) {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={e => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div>
            <label className="block text-sm text-[var(--foreground-secondary)] mb-2">Data início</label>
            <input
              type="date"
              className="input-field"
              value={startDate}
